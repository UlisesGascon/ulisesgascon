...
My current open source activity is highly focused on the JS ecosystem. I have dedicated my time to maintaining and contributing to [over 600 open source packages](/npm-ecosystem-impact.md), including some of the top 100 packages on the npm registry.
